...
export default function FAQNavy() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "ชำระเงินและส่งสลิปภายใน 15:00 น. ร้านจัดส่งภายในวันนั้น หากเกิน 15:00 น. จะจัดส่งในวันถัดไป ระยะเวลาถึงปลายทางขึ้นอยู่กับบริษัทขนส่ง",
      category: "การจัดส่ง",
    },
    {
      question: "มีส่งฟรีไหม?",
      answer: "เฉพาะสินค้าดูดแล้วทิ้ง สั่งตั้งแต่ 3 ชิ้นขึ้นไปส่งฟรี รายการอื่นมีค่าจัดส่งทั่วไทย 50 บาท",
      category: "การจัดส่ง",
    },
    {
    ...
    },
    {
      ...
      answer: "ร้านเปิดให้บริการทุกวัน ไม่มีวันหยุด รับรายการสั่งซื้อได้ตลอด 24 ชั่วโมง และตัดรอบจัดส่งเวลา 15:00 น.",
      category: "อื่นๆ",
    },
    {
