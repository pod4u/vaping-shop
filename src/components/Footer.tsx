...
export default function Footer() {
  return (
    <footer className="relative mt-24 border-t border-brand-border bg-brand-dark">
      {/* Top subtle glow line */}
      <div className="h-px w-full bg-gradient-to-r from-transparent via-vapor-violet to-transparent opacity-50"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-6">
              <div className="w-8 h-8 rounded-lg bg-vapor-violet/20 border border-brand-border flex items-center justify-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 btn-acid px-5 py-2.5 rounded-full text-xs font-black transition-all"
            >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/" className="text-white/50 hover:text-acid-lime transition-colors text-sm">
                  หน้าแรก
                </Link>
              </li>
              <li>
                <Link href="/products" className="text-white/50 hover:text-acid-lime transition-colors text-sm">
                  สินค้าทั้งหมด
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/50 text-sm">
              <li className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-vapor-violet/20 border border-brand-border flex items-center justify-center text-acid-lime shrink-0">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.48 2 2 5.58 2 10c0 2.12.92 4.04 2.42 5.44L3 22l6.4-3.2c.84.13 1.71.2 2.6.2 5.52 0 10-3.58 10-8s-4.48-8-10-8z"/>
                  </svg>
                </div>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>ดูดแล้วทิ้ง {storeConfig.freeShippingDisposableMinQuantity} ชิ้นขึ้นไป ส่งฟรี</span>
              </li>
            </ul>
          </div>
        </div>
