      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto animate-slide-up" style={{ animationDelay: '0.4s' }}>
          <div className="group navy-card rounded-2xl p-4 sm:p-5 flex items-center gap-4 text-left relative overflow-hidden card-tilt">
            ...
            <div className="relative z-10 w-12 h-12 rounded-xl bg-navy/30 border border-navy-border-light/40 flex items-center justify-center shrink-0 text-acid-lime group-hover:scale-110 group-hover:border-acid-lime/40 transition-all duration-300 shadow-lg shadow-navy/30">
