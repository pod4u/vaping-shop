      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {benefitItems.map((benefit, index) => (
            ...
            >
              {/* Inner glow on hover */}
              <div className="absolute inset-0 bg-gradient-to-br from-navy-glow/15 via-transparent to-acid-lime/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              {/* Bottom accent line */}
              <div className="absolute bottom-0 left-0 w-0 h-1 bg-gradient-to-r from-acid-lime to-navy-glow group-hover:w-full transition-all duration-500"></div>
            </div>
          ))}
        </div>
