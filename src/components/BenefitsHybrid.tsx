...
export default function BenefitsHybrid() {
  return (
    <section id="about" className="py-20 px-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-hybrid-deep via-hybrid-deep/50 to-transparent"></div>
        <div className="absolute top-[20%] left-[5%] w-[300px] h-[300px] bg-hybrid-glow/12 rounded-full blur-[100px] animate-float-slow"></div>
        <div className="absolute bottom-[30%] right-[10%] w-[250px] h-[250px] bg-hybrid-glow-bright/8 rounded-full blur-[80px] animate-float-slow" style={{ animationDelay: '-3s' }}></div>
        <div className="absolute inset-0 bg-[radial-gradient(rgba(59,130,246,0.02)_1px,transparent_1px)] bg-[size:48px_48px] opacity-40"></div>
        <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-hybrid-deep via-hybrid-deep/50 to-transparent"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {benefitItems.map((benefit, index) => (
            <div
              key={index}
              className="hybrid-card rounded-2xl p-6 hover:border-hybrid-glow-bright/50 transition-all duration-300 group relative overflow-hidden card-tilt animate-slide-up"
        ...
        {/* Shipping Banner */}
        <div className="mt-14 relative overflow-hidden rounded-3xl hybrid-card p-8 sm:p-10 border-hybrid-border-light group">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-hybrid-blue/15 rounded-full blur-[120px] group-hover:opacity-70 transition-opacity duration-700"></div>
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-hybrid-glow-bright/8 rounded-full blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-hybrid-glow/5 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
          </div>

          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-hybrid-glow to-hybrid-blue text-white flex items-center justify-center shrink-0 shadow-[0_0_30px_rgba(37,99,235,0.4)] group-hover:scale-105 transition-all duration-300">
