        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/80 text-xs sm:text-sm truncate">
                เพิ่ม LINE ใหม่: <span className="font-bold text-white-neon">{lineId}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <a
              ...
              className="flex items-center gap-2 btn-white-cta px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-colors whitespace-nowrap"
            >
