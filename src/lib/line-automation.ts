...
export function buildGreetingMessage(
  ...
  return {
    type: 'text',
    text: '👋 สวัสดีค่ะ ยินดีต้อนรับสู่ Pod4U\n\nดูสินค้าพร้อมส่งได้ทันที หรือเข้าสู่ระบบสมาชิกครั้งเดียวเพื่อให้ระบบช่วยจำข้อมูล ออเดอร์ และสถานะการจัดส่งค่ะ\n\n💳 ร้านรับชำระก่อนจัดส่งเท่านั้น ไม่มีบริการเก็บเงินปลายทางค่ะ\n\nวันนี้กำลังมองหาแบรนด์หรือรสไหนอยู่คะ',
    quickReply: {
      items: [
        stockAction,
        {
    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          { type: 'text', text: 'สมาชิกเช็กออเดอร์ สถานะการจัดส่ง และรับเครดิตรีวิว ฿5 ได้ค่ะ', size: 'xs', color: '#667085', wrap: true, margin: 'md' },
