...
export default function WarehouseLoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden p-5">
      ...
      <section className="relative w-full max-w-md rounded-[2rem] border border-white/15 bg-[#0d1830]/95 p-7 shadow-2xl shadow-black/40 sm:p-9">
        ...
        <form onSubmit={login} className="space-y-4">
          ...
          <button disabled={loading} className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#d4ff14] px-5 py-4 font-black text-[#071126] disabled:opacity-60">
