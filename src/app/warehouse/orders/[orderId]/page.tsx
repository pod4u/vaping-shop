...
interface Order { id: string; order_number: string; status: string; shipping_name: string; shipping_phone: string; shipping_address: string; shipping_province: string; shipping_postal_code: string | null; total: number | string; shipped_at: string | null; created_at: string }
