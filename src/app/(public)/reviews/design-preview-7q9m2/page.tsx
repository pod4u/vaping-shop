...
const previewData: ReviewsPreviewData = {
  ...
  reviews: [
    ...
    { id: "demo-02", rating: 5, category: "delivery", review_text: "แพ็กเรียบร้อย ส่งไวค่ะ สถานะการจัดส่งขึ้นในหน้าสมาชิก เช็กสะดวกมาก", published_at: "2026-09-09T14:08:00+07:00", masked_order_number: "P4U-***-6643", masked_customer_name: "ก*** (09X-XXX-7315)", verification_status: "delivered", items: [{ brand_name: "RELX", product_name: "RELX Pod Pro 2", flavor_name: "มิ้นท์พีช" }] },
    ...
    { id: "demo-06", rating: 5, category: "delivery", review_text: "ได้รับของเรียบร้อยค่ะ ห่อมาดีและเช็กสถานะจัดส่งจากหน้าออเดอร์ได้", published_at: "2026-09-05T10:05:00+07:00", masked_order_number: "P4U-***-92C5", masked_customer_name: "อ*** (06X-XXX-5082)", verification_status: "delivered", items: [{ brand_name: "VPLUS", product_name: "VPLUS", flavor_name: "แตงโม" }] },
