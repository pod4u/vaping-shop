...
export const products: Product[] = [
  // Disposable Pods
  {
    ...
    description: "หัวพอด RELX Pro 2 รสมินต์เย็น นิโคติน 5%",
  ...
  },
  {
    ...
    description: "พอดใช้แล้วทิ้ง ALFA Duo Mesh 20K รสบลูเบอร์รี่",
  ...
  },
  {
    ...
    description: "พอดใช้แล้วทิ้ง 20,000 พัฟฟ์ ดีไซน์สวยงาม",
  ...
  {
    id: 4,
    name: "MOOOD Monster Series 14K - Grape 5%",
    category: "disposable-pod",
    price: 350,
    image: "/images/products/moood/monster-series-14k/grape-5.jpg",
    description: "พอดใช้แล้วทิ้ง MOOOD Monster Series 14K รสองุ่น นิโคติน 5%",
    features: ["14,000 Puffs", "Grape", "5% Nicotine"],
    inStock: true,
    isFeatured: true,
  },
  // Pod Systems
  {
    ...
    description: "พอดไฟฟ้ารุ่นใหม่ แบตเตอรี่ 800mAh จอแสดงผล",
  ...
  },
  {
    ...
    description: "พอดไฟฟ้าคลาสสิก ปรับลมได้",
  ...
  },
  {
    ...
    description: "พอดไฟฟ้าขายดี รสชาติชัดเจน",
